...
st.markdown("")
st.markdown("")
st.markdown("##### <div style='color:#FAFAFA;'><div style='margin-bottom: -5px;'>Enter ratio of Nitrogen content in soil: [Range from 1 to 140]</div></div>, unsafe_allow_html=True)
