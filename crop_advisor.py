...
try:
    ...
    st.markdown("<p style='text-align: center;color:red;font-size: 20px'>Please enter a valid integer or floating number for Temperature.</p>", unsafe_allow_html=True)
    conditions_violated = True
...
try:
    ...
    st.markdown("<p style='text-align: center;color:red;font-size: 20px'>Please enter a valid integer or floating number for Humidity.</p>", unsafe_allow_html=True)
    conditions_violated = True
...
try:
    ...
    st.markdown("<p style='text-align: center;color:red;font-size: 20px'>Please enter a valid integer or floating number for pH.</p>", unsafe_allow_html=True)
    conditions_violated = True
