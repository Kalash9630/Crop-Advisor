...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px">Enter ratio of Phosphorous content in soil:  [Range from 5 to 145]</p>', unsafe_allow_html=True)
...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px">Enter ratio of Potassium content in soil:  [Range from 5 to 205]</p>', unsafe_allow_html=True)
...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px"> Enter Temperature (in °C):  [Range from 0 to 50]</p>', unsafe_allow_html=True)
...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px"> Enter value of relative Humidity (in %):  [Range from 0 to 100]', unsafe_allow_html=True)
...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px"> Enter pH value in soil:  [Range from 0 to 14]', unsafe_allow_html=True)
...
st.markdown("")
st.markdown('<p style="font-size: 21px ; margin-bottom: -50px"> Enter value of Rainfall (in mm):  [Range from 15 to 300]', unsafe_allow_html=True)
